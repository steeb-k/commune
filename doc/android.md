...
* [S3 — the build host, and libadwaita running](#s3--the-build-host-and-libadwaita-running)
...
| libadwaita checkout | `~/src/libadwaita` — **builds and runs** on Arch |
...
## S3 — the build host, and libadwaita running
...
* 125–136 MB debug APKs, unmeasured stripped size.
